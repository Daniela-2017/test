    ...
    if (isVideo) {
      ...
      await _displayPickImageDialog(context!,
        ...
        try {
          ...
          setState(() {
            _tempimageFileList = pickedFileList;
          });
        } catch (e) {
          setState(() {
            _pickImageError = e;
      ...
      return Semantics(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              print("**************** ${_tempimageFileList![index].path}");
              // Why network for web?
              // See https://pub.dev/packages/image_picker#getting-ready-for-the-web-platform
              return Semantics(
                label: 'image_picker_example_picked_image',
                child: kIsWeb
                    ? Image.network(_tempimageFileList![index].path)
                    : Image.file(File(_tempimageFileList![index].path)),
              );
            },
